...
IMAGE_DIR = (
    "/teamspace/studios/this_studio/Work/CrazyMatching/tfod_coco_ssd/data/images"
)
ANNOTATIONS_DIR = (
    "/teamspace/studios/this_studio/Work/CrazyMatching/tfod_coco_ssd/data/annotations"
)
...
def convert_pascal_to_tfrecord(image_dir, annotations_dir, output_path, label_map):
    ...
    for xml_file in xml_files:
        ...
        if not os.path.exists(image_path):
            print(
                f"Warning: Image {image_path} not found for annotation {xml_file}. Skipping."
            )
            continue
