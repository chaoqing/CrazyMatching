...
def generate_tfod_data(
    num_samples=100,
    output_base_dir=".",
    original_assets_dir="/teamspace/studios/this_studio/Work/CrazyMatching/model/data",
):
    """
    ...
    for i in range(num_samples):
        ...
        while len(placed_objects) < num_animals_to_place and attempts < 200:
            ...
            if target_w == 0 or target_h == 0:
                continue  # Avoid zero-sized images
            ...
            if max_x <= 0 or max_y <= 0:
                continue  # Animal is too large for background
...
if __name__ == "__main__":
    ...
    if not image_files:
        ...
        if annotation_path.exists():
            ...
            print(
                f"Error: Could not find corresponding annotation for {random_image_path.name}"
            )
    print("\n--- Finished Step 2 ---")
