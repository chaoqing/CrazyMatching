...
def convert_pytorch_to_onnx():
    ...
    )  # Create model with pretrained backbone for consistent architecture
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "Warning: onnx not found in current environment. It is required for PyTorch to ONNX conversion."
        )
